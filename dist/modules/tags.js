...
var Tags = /** @class */ (function (_super) {
    ...
    Tags.prototype.getAll = function (tagName, includeAll, page, pageSize) {
        ...
        var requestOptions = this._getBasePaginatedRequestOptions(__assign({}, this.baseOptions, { key: 'tags', tagName: tagName, pageSize: pageSize, page: page, includeAll: includeAll }));
